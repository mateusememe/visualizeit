...
\title{Visualização de Acidentes Ferroviários - ANTT\\
...
\IEEEauthorblockN{Mateus Mendonça Monteiro\textsuperscript{1}, 
                  Cássio Machiaveli Oishi\textsuperscript{2},
                  Danilo Medeiros Eler\textsuperscript{3} 
                  }
\IEEEauthorblockA{
\textit{Departamento de Matemática e Computação},
\textit{Universidade Estadual Paulista}\\
Presidente Prudente, Brasil\\
\{mateus.monteiro, cassio.oishi, danilo.eler\}@unesp.br
}
}
